              ...
              <div className="col-xl-5 col-lg-6 col-md-8 col-sm-10">
                <div className="about-content mt-md-50">
                  <div className="section-heading mb-20">
                    <span className="tagline color-tertiary">About Nubiprotech</span>
                    <h2 className="title">
                  ...
                  <div className="blog-content">
                    <div className="blog-meta">
                      ...
                      <a href="#" className="blog-date">
                        <i className="far fa-calendar-alt" /> 25 Aug 2025
                      </a>
                    </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-10">
                <div className="latest-blog-two style-two mt-30">
                  ...
                  <div className="blog-content">
                    ...
                    <h4 className="blog-title">
                      <Link href="/blog-details">
                        <a>Front-End Performance Checklist 2025 PDF</a>
                      </Link>
                    </h4>
                    <p>
                      Sed perspiciatis unde omnis natus error voluptatem
          ...
          >
            <div className="container">
                  ...
                  <div className="col-lg-3 col-md-8">
                    <div className="widget text-widget">
                      <div className="footer-logo">
                        <img src="assets/img/logo-white-3.png" alt="Nubiprotech" />
                      </div>
                      <p>
                      ...
                      <ul className="contact-list">
                        ...
                        <li>
                          <a href="mailto:nubiprotech@gmail.com">
                            <i className="far fa-envelope" />
                            nubiprotech@gmail.com
                          </a>
                        </li>
                        <li>
                          <a href="tel:01267899">
              ...
              <div className="copyright-area">
                <p>
                  © 2025 <a href="#">Nubiprotech</a>. All Rights Reserved
                </p>
              </div>
            </div>
          </div>
